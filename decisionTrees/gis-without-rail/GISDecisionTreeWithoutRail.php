 ...
 */
class GISDecisionTreeWithoutRail implements DecisionTreeInterface
{
    protected $tree;
    ...
    function __construct()
    {
                    ...
                    $node4->setDecision(new Decision('ptscloseness', '>', 20.5));
                                    $node5 = new Node();
                    $node5->setDecision(new Decision('stoprate', '>', 0.001));
                                    $node6 = new Node();
                            ...
                            $node8 = new Node();
                    $node8->setDecision(new Decision('ptscloseness', '>', 1.5));
                                    $node9 = new Node();
                    $node9->setDecision(new Decision('meanacceleration', '>', 4.8));
                                    $node10 = new Node();
                            ...
                            $node13 = new Node();
                    $node13->setDecision(new Decision('meanvelocity', '>', 7.594));
                                    $node14 = new Node();
                            ...
                            $node15 = new Node();
                    $node15->setDecision(new Decision('stoprate', '>', 0.002));
                                    $node16 = new Node();
                    $node16->setDecision(new Decision('maxvelocity', '>', 10.906));
                                    $node17 = new Node();
                    $node17->setDecision(new Decision('ptscloseness', '>', 2));
                                    $node18 = new Node();
                            ...
                            $node19 = new Node();
                    $node19->setDecision(new Decision('meanacceleration', '>', 1.571));
                                    $node20 = new Node();
                    $node20->setDecision(new Decision('meanacceleration', '>', 1.816));
                                    $node21 = new Node();
                            ...
                            $node25 = new Node();
                    $node25->setDecision(new Decision('maxacceleration', '>', 2.403));
                                    $node26 = new Node();
                    $node26->setDecision(new Decision('meanacceleration', '>', 2.436));
                                    $node27 = new Node();
                    $node27->setDecision(new Decision('highwaycloseness', '>', 0));
                                    $node28 = new Node();
                            ...
                            $node31 = new Node();
                    $node31->setDecision(new Decision('stoprate', '>', 0));
                                    $node32 = new Node();
                            ...
                            $node34 = new Node();
                    $node34->setDecision(new Decision('maxvelocity', '>', 44.538));
                                    $node35 = new Node();
                            ...
                            $node36 = new Node();
                    $node36->setDecision(new Decision('stoprate', '>', 0.129));
                                    $node37 = new Node();
                    $node37->setDecision(new Decision('stoprate', '>', 0.166));
                                    $node38 = new Node();
                            ...
                            $node40 = new Node();
                    $node40->setDecision(new Decision('meanvelocity', '>', 1.947));
                                    $node41 = new Node();
                            ...
                            $node20->setRight($node22);
                                    $node21->setParent($node21);
                                                    ...
                                                    $node25->setParent($node15);
                            $node25->setLeft($node26);
                            $node25->setRight($node31);
